...
namespace Mirror.FizzySteam
{
    public abstract class NextCommon
    {
        ...
        protected (byte[], int) ProcessMessage(IntPtr ptrs)
        {
            ...
            //HACK: If you have choosen to implement the latest change set from Steamworks.NET as documented here: https://github.com/rlabrecque/Steamworks.NET/issues/424 then you can safely uncomment the following code
            
            //NOTE: Heathen's Steamworks Foundation and Steamworks Complete already has 424 implemented and so you can safely use the following code as is
